import{b as g}from"./lit-element-BrtkDOYA.js";import{o as I}from"./unsafe-html-DX_ZMqK7.js";import"./directive-CF8sV3Lr.js";var u=Object.freeze,L=Object.defineProperty,j=(e,t)=>u(L(e,"raw",{value:u(t||e.slice())})),y;function f(e){const t=document.createElement("aa-signal-protocol"),r=[["name","interactive-preview"],["schedule-type",e.scheduleType],["signals-per-day",e.signalsPerDay],["window-start",e.windowStart],["window-end",e.windowEnd],["signal-windows",e.signalWindows],["min-interval",e.minInterval],["fixed-times",e.fixedTimes],["fixed-times-label",e.fixedTimesLabel],["active-days",e.activeDays],["exclude-dates",e.excludeDates],["exclude-times",e.excludeTimes],["weekend-signals-per-day",e.weekendSignalsPerDay],["weekend-window-start",e.weekendWindowStart],["weekend-window-end",e.weekendWindowEnd],["weekend-signal-windows",e.weekendSignalWindows],["weekend-fixed-times",e.weekendFixedTimes],["signal-expiry",e.signalExpiry],["reminder-after",e.reminderAfter],["reminder-count",e.reminderCount]];for(const[o,a]of r)a!=null&&a!==""&&t.setAttribute(o,String(a));return t}const x=`<aa-signal-protocol
...
</aa-signal-protocol>`,S=`<aa-signal-protocol
  name="work-stress"
  schedule-type="stratified-random"
  signals-per-day="6"
...
</aa-signal-protocol>`,h=`<aa-signal-protocol
  name="mixed-protocol"
  schedule-type="stratified-random"
  signals-per-day="5"
  window-start="10:00"
...
</aa-signal-protocol>`,b=`<aa-signal-protocol
  name="daily-diary"
  schedule-type="fixed"
  ...
  <aa-session name="diary-assessment" should-run="false">
...
</aa-signal-protocol>`;let q=0;function p(e){const t=`protocol-summary-${++q}-${Date.now()}`;return g(y||(y=j([`
    <div class="protocol-story-wrapper" style="font-family: monospace; padding: 16px;">
      ...
      <script type="module">
        setTimeout(() => {
          const wrapper = document.querySelector('[data-summary-id="`,`"]');
          if (!wrapper) return;
...
}`,...(k=(D=s.parameters)==null?void 0:D.docs)==null?void 0:k.source}}};var T,E,W;d.parameters={...d.parameters,docs:{...(T=d.parameters)==null?void 0:T.docs,source:{originalSource:`{
...
}`,...(W=(E=d.parameters)==null?void 0:E.docs)==null?void 0:W.source}}};var M,P,O;l.parameters={...l.parameters,docs:{...(M=l.parameters)==null?void 0:M.docs,source:{originalSource:`{
...
}`,...(O=(P=l.parameters)==null?void 0:P.docs)==null?void 0:O.source}}};var Y,A,R;c.parameters={...c.parameters,docs:{...(Y=c.parameters)==null?void 0:Y.docs,source:{originalSource:`{
...
}`,...(R=(A=c.parameters)==null?void 0:A.docs)==null?void 0:R.source}}};var N,C,H;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`{
  argTypes: {
    scheduleType: {
      control: {
        type: "select"
...
}`,...(H=(C=m.parameters)==null?void 0:C.docs)==null?void 0:H.source}}};const V=["ClassicStratifiedRandomESM","WeekdayWeekendSplit","FixedDiaryPlusRandomSignals","FixedTimeOnly","ScheduleExplorer"];export{s as ClassicStratifiedRandomESM,l as FixedDiaryPlusRandomSignals,c as FixedTimeOnly,m as ScheduleExplorer,d as WeekdayWeekendSplit,V as __namedExportsOrder,z as default};
