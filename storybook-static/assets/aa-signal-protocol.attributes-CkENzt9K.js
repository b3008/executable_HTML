import{j as e}from"./jsx-runtime-DjjJRqnr.js";import{M as r}from"./index-BZwxqCSI.js";import{u as s}from"./index-BHT9JHh8.js";import"./iframe-vNrS5K6G.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Bw8VTzHM.js";import"./index-BNKdAXne.js";import"./index-DrFu-skq.js";function i(d){const n=Object.assign({h1:"h1",code:"code",p:"p",pre:"pre",hr:"hr",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong",em:"em",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td"},s(),d.components);return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Data & Utility/SignalProtocol/Attribute Reference"}),`
...
`,e.jsxs(n.table,{children:[e.jsx(n.thead,{children:e.jsxs(n.tr,{children:[e.jsx(n.th,{children:"Value"}),e.jsx(n.th,{children:"Meaning"})]})}),e.jsxs(n.tbody,{children:[e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:'"all"'})}),e.jsx(n.td,{children:"Every day (default)"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:'"weekdays"'})}),e.jsx(n.td,{children:"Monday through Friday"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:'"weekends"'})}),e.jsx(n.td,{children:"Saturday and Sunday"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:'"Mon,Wed,Fri"'})}),e.jsx(n.td,{children:"Comma-separated day names (3-letter or full)"})]})]})]}),`
...
`,e.jsxs(n.table,{children:[e.jsx(n.thead,{children:e.jsxs(n.tr,{children:[e.jsx(n.th,{children:"Attribute"}),e.jsx(n.th,{children:"Format"}),e.jsx(n.th,{children:"Default"}),e.jsx(n.th,{children:"Used by"})]})}),e.jsxs(n.tbody,{children:[e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"schedule-type"})}),e.jsxs(n.td,{children:[e.jsx(n.code,{children:"fixed"})," · ",e.jsx(n.code,{children:"random"})," · ",e.jsx(n.code,{children:"stratified-random"})]}),e.jsx(n.td,{children:"—"}),e.jsx(n.td,{children:"All"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"signals-per-day"})}),e.jsx(n.td,{children:"Integer"}),e.jsx(n.td,{children:"—"}),e.jsxs(n.td,{children:[e.jsx(n.code,{children:"random"}),", ",e.jsx(n.code,{children:"stratified-random"})]})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"window-start"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"HH:MM"})}),e.jsx(n.td,{children:"—"}),e.jsxs(n.td,{children:[e.jsx(n.code,{children:"random"}),", ",e.jsx(n.code,{children:"stratified-random"})]})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"window-end"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"HH:MM"})}),e.jsx(n.td,{children:"—"}),e.jsxs(n.td,{children:[e.jsx(n.code,{children:"random"}),", ",e.jsx(n.code,{children:"stratified-random"})]})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"signal-windows"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"HH:MM-HH:MM;..."})}),e.jsx(n.td,{children:"—"}),e.jsxs(n.td,{children:[e.jsx(n.code,{children:"random"}),", ",e.jsx(n.code,{children:"stratified-random"})]})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"min-interval"})}),e.jsx(n.td,{children:"Duration"}),e.jsx(n.td,{children:e.jsx(n.code,{children:"15min"})}),e.jsxs(n.td,{children:[e.jsx(n.code,{children:"random"}),", ",e.jsx(n.code,{children:"stratified-random"})]})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"signal-expiry"})}),e.jsx(n.td,{children:"Duration"}),e.jsx(n.td,{children:e.jsx(n.code,{children:"15min"})}),e.jsx(n.td,{children:"All (response window)"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"reminder-after"})}),e.jsx(n.td,{children:"Duration"}),e.jsx(n.td,{children:"—"}),e.jsx(n.td,{children:"All"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"reminder-count"})}),e.jsx(n.td,{children:"Integer"}),e.jsx(n.td,{children:e.jsx(n.code,{children:"1"})}),e.jsxs(n.td,{children:["All (requires ",e.jsx(n.code,{children:"reminder-after"}),")"]})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"fixed-times"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"HH:MM,HH:MM,..."})}),e.jsx(n.td,{children:"—"}),e.jsxs(n.td,{children:["All (required for ",e.jsx(n.code,{children:"fixed"}),")"]})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"fixed-times-label"})}),e.jsx(n.td,{children:"String"}),e.jsx(n.td,{children:"—"}),e.jsx(n.td,{children:"All (cosmetic)"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"active-days"})}),e.jsxs(n.td,{children:[e.jsx(n.code,{children:"all"})," · ",e.jsx(n.code,{children:"weekdays"})," · ",e.jsx(n.code,{children:"weekends"})," · names"]}),e.jsx(n.td,{children:e.jsx(n.code,{children:"all"})}),e.jsx(n.td,{children:"All"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"exclude-dates"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"YYYY-MM-DD,..."})}),e.jsx(n.td,{children:"—"}),e.jsx(n.td,{children:"All"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"exclude-times"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"HH:MM-HH:MM;..."})}),e.jsx(n.td,{children:"—"}),e.jsx(n.td,{children:"All"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"study-days"})}),e.jsx(n.td,{children:"Integer"}),e.jsx(n.td,{children:"—"}),e.jsx(n.td,{children:"Informational"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"start-date"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"YYYY-MM-DD"})}),e.jsx(n.td,{children:"—"}),e.jsx(n.td,{children:"Informational"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"end-date"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"YYYY-MM-DD"})}),e.jsx(n.td,{children:"—"}),e.jsx(n.td,{children:"Informational"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"weekend-signals-per-day"})}),e.jsx(n.td,{children:"Integer"}),e.jsx(n.td,{children:"inherits"}),e.jsx(n.td,{children:"Weekend override"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"weekend-window-start"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"HH:MM"})}),e.jsx(n.td,{children:"inherits"}),e.jsx(n.td,{children:"Weekend override"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"weekend-window-end"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"HH:MM"})}),e.jsx(n.td,{children:"inherits"}),e.jsx(n.td,{children:"Weekend override"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"weekend-signal-windows"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"HH:MM-HH:MM;..."})}),e.jsx(n.td,{children:"inherits"}),e.jsx(n.td,{children:"Weekend override"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"weekend-fixed-times"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"HH:MM,HH:MM,..."})}),e.jsx(n.td,{children:"inherits"}),e.jsx(n.td,{children:"Weekend override"})]})]})]}),`
`,e.jsx(n.hr,{}),`
...
`})}),`
`,e.jsxs(n.table,{children:[e.jsx(n.thead,{children:e.jsxs(n.tr,{children:[e.jsx(n.th,{children:"Method / Property"}),e.jsx(n.th,{children:"Returns"}),e.jsx(n.th,{children:"Description"})]})}),e.jsxs(n.tbody,{children:[e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"getProtocol()"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"SignalProtocolConfig"})}),e.jsx(n.td,{children:"Structured object of all parsed attribute values"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"getSignallingTimes(start, end)"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"Date[]"})}),e.jsx(n.td,{children:"Concrete signal times for the given date range"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"validate()"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"string[]"})}),e.jsx(n.td,{children:"Array of warning messages (empty if valid)"})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"toJSON()"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"object"})}),e.jsx(n.td,{children:"JSON-serialisable representation"})]})]})]}),`
`,e.jsx(n.h3,{id:"events",children:"Events"}),`
`,e.jsxs(n.table,{children:[e.jsx(n.thead,{children:e.jsxs(n.tr,{children:[e.jsx(n.th,{children:"Event"}),e.jsx(n.th,{children:"When"})]})}),e.jsx(n.tbody,{children:e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"protocolReady"})}),e.jsx(n.td,{children:"Fired asynchronously when the element connects and validates"})]})})]})]})}function g(d={}){const{wrapper:n}=Object.assign({},s(),d.components);return n?e.jsx(n,Object.assign({},d,{children:e.jsx(i,d)})):i(d)}export{g as default};
