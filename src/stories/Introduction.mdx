...
Wrap your content in an `aa-session`, define a sequence of screens, and the framework handles the rest — progression, data collection, branching logic, and storage.
