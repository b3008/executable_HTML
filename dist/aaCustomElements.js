...
part of the polymer project is also subject to an additional IP rights grant
found at http://polymer.github.io/PATENTS.txt
*/;rs.setAttribute("strip-whitespace",""),oi({_template:rs,is:"paper-button",behaviors:[ss],properties:{raised:{type:Boolean,reflectToAttribute:!0,value:!1,observer:"_calculateElevation"}},_calculateElevation:function(){this.raised?is._calculateElevation.apply(this):this._setElevation(0)}})}})},function(e,t,n){"use strict";var i=n(0);class s extends i.a{static get observedAttributes(){return["name","should-run","debug"]}constructor(){super(),this.root=this.attachShadow({mode:"open"}),this.root.innerHTML="<slot></slot>"}connectedCallback(){this.started||(this.started=!0,void 0!==this.innerFragment&&(i.a.scanAndReplace(this.innerFragment),this.appendChild(this.innerFragment)))}}customElements.get("aa-when")||(window.AANodeNames=window.AANodeNames||[],window.AANodeNames.push("AA-WHEN"),customElements.define("aa-when",s))},function(e,t,n){"use strict";var i=n(0);class s extends i.a{constructor(){super()}connectedCallback(){this.started||(this.started=!0,void 0!==this.innerFragment&&(i.a.scanAndReplace(this.innerFragment),this.appendChild(this.innerFragment)))}}customElements.get("aa-otherwise")||(window.AANodeNames=window.AANodeNames||[],window.AANodeNames.push("AA-OTHERWISE"),customElements.define("aa-otherwise",s))},function(e,t){e.exports=function(e){if(!e.webpackPolyfill){var t=Object.create(e);t.children||(t.children=[]),Object.defineProperty(t,"loaded",{enumerable:!0,get:function(){return t.l}}),Object.defineProperty(t,"id",{enumerable:!0,get:function(){return t.i}}),Object.defineProperty(t,"exports",{enumerable:!0}),t.webpackPolyfill=1}return t}},,function(e,t,n){"use strict";n.r(t);n(3);var i=n(0);class s extends i.a{static get observedAttributes(){return["name","value"]}constructor(){super(),this.root=this.attachShadow({mode:"open"})}connectedCallback(){this._getParentSession().setData(this.name,this.value)}}customElements.get("aa-variable")||(window.AANodeNames=window.AANodeNames||[],window.AANodeNames.push("AA-VARIABLE"),customElements.define("aa-variable",s));class r extends i.a{static get observedAttributes(){return["name","debug","value","min","max"]}constructor(){super()}connectedCallback(){let e=this._getParentSession();this.value=this.getValue(),e.setData(this.name,this.value),this._dispatchEndEvent({autoDispatch:!0})}getValue(){var e=parseFloat(this.min),t=parseFloat(this.max);return this.getRandomInt(e,t)}getRandomInt(e,t){return e=Math.ceil(e),t=Math.floor(t),Math.floor(Math.random()*(t-e)+.5)+e}}customElements.get("aa-function-random")||(window.AANodeNames=window.AANodeNames||[],window.AANodeNames.push("AA-FUNCTION-RANDOM"),customElements.define("aa-function-random",r));var o=n(1);class a extends i.a{get observedAttributes(){return["name"]}constructor(){super()}connectedCallback(){}setData(e,t){this.dataset[e]=t}getData(e){return this.dataset[this.toHyphenated(e)]}}customElements.get("aa-memory")||(void 0===window.AANodeNames&&(window.AANodeNames=[]),window.AANodeNames.push("AA-MEMORY"),customElements.define("aa-memory",a));class l extends i.a{static get observedAttributes(){return["submit-button-text","submit-button-hidden","name"]}attributeChangedCallback(e,t,n){switch(e){case"submit-button-text":this.submitButton.innerHTML=n;break;case"submit-button-hidden":this.root.querySelector(".submitButtonContainer").style.display=!0!==n||"true"!==n?"block":"none"}}constructor(){super(),this.root=this.attachShadow({mode:"open"})}connectedCallback(){super.connectedCallback(),this.root.innerHTML=this.css+this.html,this.submitButton=this.root.querySelector(".submitButton"),this._started||(this._started=!0,this.submitButtonHidden&&(this.root.querySelector(".submitButtonContainer").style.display="none"),null!=this.innerFragment&&this.appendChild(this.innerFragment),this.root.querySelector(".submitButton").addEventListener("click",this.submitButtonClick.bind(this)))}get css(){return html`
            <style>
                :host {
                    display: block;
                    height: fit-content;
